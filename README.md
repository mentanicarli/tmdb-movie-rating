...
- 🗳️ **Количество оценок (vote_count)** — чем больше людей оценило фильм, тем предсказуемее его рейтинг (15.5%)
...
```bash
git clone https://github.com/твой-ник/tmdb-movie-rating.git
cd tmdb-movie-rating
```
